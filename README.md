...
| `Additional Numerical Studies`              | Include expanded out-of-sample accuracy diagnostics, MC-IS benchmark protocol and offline computational cost, economic monotonicity diagnostics and stability to architecture selection      |
## Purpose
